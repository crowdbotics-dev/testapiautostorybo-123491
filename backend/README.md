...
## Project Structure
    ...
    ├── testapiautostorybo_123491  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_123491`
...
2. Clone this repo and `cd testapiautostorybo_123491`
